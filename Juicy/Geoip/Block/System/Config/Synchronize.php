...
class Juicy_Geoip_Block_System_Config_Synchronize extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /*
     * Set template
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('juicy/geoip/system/config/synchronize.phtml');
    }
